...
Remove-Module M365Copilot.PSTools -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\M365Copilot.PSTools\M365Copilot.PSTools.psd1"
Import-Module "$PSScriptRoot\..\M365Copilot.PSTools\M365Copilot.PSTools.psm1" -Force
