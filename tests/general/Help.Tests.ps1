...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\M365Copilot.PSTools\functions", "$global:testroot\..\M365Copilot.PSTools\internal\functions"),
	
	[string]
	$ModuleName = "M365Copilot.PSTools",
...
$CommandPath = @(
    "$global:testroot\..\M365Copilot.PSTools\functions"
    "$global:testroot\..\M365Copilot.PSTools\internal\functions"
)
